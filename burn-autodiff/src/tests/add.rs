...
mod tests {
    ...
    fn should_diff_add_scalar() {
        ...
        let tensor = TestAutodiffTensor::from(data).require_grad();
    ...
    fn test_add_complex_1() {
        ...
        let tensor_1 = TestAutodiffTensor::from(data_1).require_grad();
        let tensor_2 = TestAutodiffTensor::from(data_2).require_grad();
        let tensor_3 = TestAutodiffTensor::from(data_3).require_grad();
