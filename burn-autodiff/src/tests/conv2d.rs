...
mod tests {
    ...
    fn test_conv2d_groups_different_channels() {
        ...
        let grads = Grads {
            ...
            bias: TestTensor::from([4., 4., 4., 4., 4., 4.]),
        };
        test.assert_grads(grads);
    }
    ...
    impl Conv2dTestCase {
        fn assert_grads(self, expected_grads: Grads) {
            ...
            let weight = TestAutodiffTensor::from(
            ...
            .require_grad();
            let bias = TestAutodiffTensor::from(
