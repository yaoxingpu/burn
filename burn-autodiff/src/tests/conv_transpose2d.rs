...
mod tests {
    ...
    fn test_conv_transpose2d_padding() {
        ...
        let grads = Grads {
            ...
            weight: TestTensor::from([[[[63., 57., 51.], [68., 60., 52.], [39., 33., 27.]]]]),
            bias: TestTensor::from([8.]),
        };
        test.assert_grads(grads);
    }
    ...
    fn test_conv_transpose2d_complex_no_groups() {
        ...
        let grads = Grads {
            ...
            bias: TestTensor::from([896., 896., 896.]),
        };
        test.assert_grads(grads);
    }
